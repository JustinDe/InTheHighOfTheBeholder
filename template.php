...
#board{
	background: url('http://hashtagnerd.com/InTheHighOfTheBeholder/images/tempbg.jpg') no-repeat top center;
...
<div id="audio"><audio controls autoplay>
  ...
  Your browser does not support the audio element.
	...
	<section id="board">
	<div class="char"><img src="http://hashtagnerd.com/InTheHighOfTheBeholder/images/temp.png"></div>
		<div id="message">
